...
export default function About(){
    ...
    return(<section className='flex flex-col md:flex-row bg-secondary'>
...
<h1 className='  text-4xl text-white border-b-4 w-[172px] border-[rgb(85,81,227)]  mb-5 font-bold'>About Me</h1>
